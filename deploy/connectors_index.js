...
const list = [
  ...
  { id: 'discover', ico: '🎯', name: '발굴(유튜브 댓글)', status: '연결됨', gate: '분류·명단(연락은 사람)' },
  { id: 'listening', ico: '👂', name: '소셜 리스닝(공개 커뮤니티)', status: '연결됨', gate: '탐지·분류(연락은 사람)' },
  { id: 'web', ico: '🌐', name: '웹 조사(실시간 상품·약관·시세)', status: '연결됨', gate: '근거+출처(라이브 검색=검색API)' },
